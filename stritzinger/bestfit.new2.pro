...
readcol,'temp.dat',a1,a2,a3,format='d,d,d'
;print,X,Y
...
plot, (x1_new/days2sec)-riset,alog10(Edep[*,0]),xstyle=1,yrange = [40.d0,43.5],xtitle='Days since L!Lmax!N',ytitle='log Edep (ergs/s)' ,xrange=[-20.0,115],charthick=6
...
;printf,1,(x1_new[j]/days2sec)-riset,alog10(Edep[j,0]),alog10(Edep[j,1]),alog10(Edep[j,2])
;endfor
;close,1

set_plot,'ps'
device,file='SN01ay.Edep.eps',/color,/encapsulated

plot, (x1_new/days2sec)-riset,alog10(Edep[*,0]),xstyle=1,yrange = [40.,43.5],xtitle='Days since L!Lmax!N',ytitle='log!L10!N(Lum)  erg s!U-1!N' ,xrange=[-20.0,115],thick=6,charthick=4
...
xyouts,75,43.5,'SN 2001ay',charthick=4,charsiz=1.5
device, /close
set_plot,'X'


for j = 1, N-1 do begin
print, (x1_new/days2sec)-riset, alog10(Edep[*,j])
endfor

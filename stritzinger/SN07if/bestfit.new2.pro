...
readcol,'SN07if.dat',a1,a2,a3,format='d,d,d'
;print,X,Y
...
plot, (x1_new/days2sec)-riset,alog10(Edep[*,0]),xstyle=1,yrange = [40.d0,43.5],title='SN2001ay 0.51M_sun of Ni, to=59.2',xtitle='Days since max',ytitle='log Edep (ergs/s)' ,xrange=[-20.0,115],charthick=6
...
set_plot,'ps'
device,file='SN07if.Edep.eps',/color,/encapsulated

plot, (x1_new/days2sec)-riset,alog10(Edep[*,0]),xstyle=1,yrange = [40.d0,43.5],title='SN2001ay 0.51M_sun of Ni, to=59.2',xtitle='Days since max',ytitle='log Edep (ergs/s)' ,xrange=[-20.0,115],thick=6,charthick=4

...
class fid_time:
	...
	Nni=self.numb(np.random.normal(self.mni, self.e_mni))
...
def main(path):
    ...
    for i in filelist:
	    ...
	    dm15 = - (mni -1.3) /0.62
            ...
            popt, pcov = curve_fit(fid.edp_mc, b[:,0], b[:,1], p0=[20.])
            #    print popt
